...
%  
%\bibitem{CKO} 
%  W.~Chemissany, R.~Kallosh and T.~Ortin,
%  ``Born-Infeld with Higher Derivatives,''
%  \arxiv{1112.0332} [hep-th].
%   
%   
%
%\bibitem{BCFKR} 
...
%  \arxiv{arXiv:1202.0014} [hep-th].
%  %%CITATION = ARXIV:1202.0014;%%
%
% %\cite{Gunaydin:2009pk}
%\bibitem{Gunaydin:2009pk} 
%  M.~Gunaydin,
...
%  %%CITATION = ARXIV:0908.0374;%%
%  %%CITATION = ARXIV:1010.2150;%%
% %\cite{de Wit:2007dn}
%%\bibitem{de Wit:2007dn} 
%  B.~de Wit,
%  ``BPS black holes,''
%  Nucl.\ Phys.\ Proc.\ Suppl.\  {\bf 171}, 16 (2007)
%  \arxiv{0704.1452} [hep-th].
%  %%CITATION = ARXIV:0704.1452;%%  
%%\cite{Ferrara:2006em}
%%\bibitem{Ferrara:2006em}
%  S.~Ferrara and R.~Kallosh,
%  ``On \N$=8$ attractors,''
%  Phys.\ Rev.\  D {\bf 73} (2006) 125005
%  \arxiv{hep-th/0603247}.
%  %%CITATION = PHRVA,D73,125005;%%
%
%
%%\cite{Hull:1994ys}
%\bibitem{Hull:1994ys} 
...
%
%
%%\cite{Banerjee:2011jp}
%\bibitem{Banerjee:2011jp} 
%  S.~Banerjee, R.~K.~Gupta, I.~Mandal and A.~Sen,
% % ``Logarithmic Corrections to N=4 and \N$=8$ Black Hole Entropy: A One Loop Test of Quantum Gravity,''
%  JHEP {\bf 1111}, 143 (2011)
% \arxiv{1106.0080} [hep-th]].
%  %%CITATION = ARXIV:1106.0080;%%
%
%
%%\cite{Borsten:2011is}
%\bibitem{Borsten:2011is} 
%  L.~Borsten, M.~J.~Duff, A.~Marrani and W.~Rubens,
% % ``On the Black-Hole/Qubit Correspondence,''
%  Eur.\ Phys.\ J.\ Plus {\bf 126}, 37 (2011)
%  \arxiv{1101.3559} [hep-th].
%  %%CITATION = ARXIV:1101.3559;%%
%  
%  %\cite{Kallosh:2006zs}
%\bibitem{Kallosh:2006zs} 
%  R.~Kallosh and A.~D.~Linde,
%  ``Strings, black holes, and quantum information,''
%  Phys.\ Rev.\ D {\bf 73}, 104033 (2006)
%  [  \arxiv{hep-th/0602061}].
%  %%CITATION = HEP-TH/0602061;%%
%
%%\cite{Broedel:2011ib}
%\bibitem{Broedel:2011ib} 
%  J.~Broedel and R.~Kallosh,
% % ``From lightcone actions to maximally supersymmetric amplitudes,''
%  JHEP {\bf 1106}, 024 (2011)
%\arxiv{1103.0322} [hep-th]].
%  %%CITATION = ARXIV:1103.0322;%%
%

%\cite{Carrasco:2011mn}
\bibitem{Carrasco:2012ca}
    {J.~J.~M.~Carrasco}, M.~Chiodaroli, M.~Günaydin and R.~Roiban,
